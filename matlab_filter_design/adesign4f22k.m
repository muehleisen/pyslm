...
fs=logspace(1,log10(12000), 1000)
...
freq_weights = [15, 20, 25, 32, 50, 63,  125, 250, 500, 1000, 2000, 4000, 6000, 8000, 10000, 11000] 
...
% N=210 with weights below
% weights = [5000, 5000, 5000, 2000, 200, 200, 200, 200, 200, 200, 200, 200, 20, 0.01, 0.01, 0.001]

freq_weights = [15, 20, 25, 32, 50, 63,  125, 250, 500, 1000, 2000,3000 4000, 8000, 10000, 10700, 11000] 
weights = [ 5000, 1000, 5000, 3000, 2000, 200, 100, 100, 100, 100, 10, 10, 10, 10, 1, 0.1,0.1, 0.1]
...
for N=Nlist
    ...
    %[bd4,ad4]=invfreqz(hs2,pi*fs2/max(fs2),Norder,Norder,wt,100,0.00001);
