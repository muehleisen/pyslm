...
weights = [10000, 10000, 10000, 300, 2000, 200, 100, 100, 100, 100, 10, 10, 10, 1, 0.01, 0.01, 0.01, .1]
...
Nmin
disp('From freqz')
disp(sprintf('a_Awt_%2.0fk=[%#1.15g,%#1.15g,%#1.15g,%#1.15g,%#1.15g,%#1.15g]',Fs/1000,ad4))
disp(sprintf('b_Awt_%2.0fk=[%#1.15g,%#1.15g,%#1.15g,%#1.15g,%#1.15g,%#1.15g,]',Fs/1000,bd4))
disp('From bilinear')
